...
voigt2=["Voigtian::signalPass(x, meanPass[90,80,100], widthPass[2.495], sigmaPass[2,1,6])",
...
fitfunctions_altsig={
    ...
    'voigtPlusCubic1':voigt+Cubic1,
    'voigtPlusCubic1b':voigt+Cubic1b,
    'voigtPlusCubic1d':voigt+Cubic1d,
    'voigt2PlusExpo1':voigt2+Expo1,
    'voigt2PlusExpo1b':voigt2+Expo1a,
    'voigt2PlusCMS1':voigt2+CMS1,
    'voigt2PlusCMS1b':voigt2+CMS1a,
    'voigt2PlusCMS1d':voigt2+CMS1c,
    'voigt2PlusCMS1f':voigt2+CMS1e,
    'voigt2PlusCubic1':voigt2+Cubic1,
    'voigt2PlusCubic1b':voigt2+Cubic1a,
    'voigt2PlusCubic1d':voigt2+Cubic1c,
}

baseOutDir = 'results/muon2017idiso/'

#### For ID&ISO (2017 Data & MC)#####################
#passcondition='Medium > 0.5 && relTkIso < 0.10'
#eventexp='tag_IsoMu24==1 && tag_pt > 26 && mass > 60 && mass < 130 && tag_charge*charge < 0 && -0.2 < tag_dB && tag_dB < 0.2 && tag_combRelIsoPF04dBeta < 0.15 && -0.5 < tag_dzPV && tag_dzPV < 0.5 && pair_probeMultiplicity_Pt10_M60140==1 && charge > 0'
#eventexpMC='(tag_IsoMu24==1 && tag_pt > 26 && mass > 60 && mass < 130 && tag_charge*charge < 0 && -0.2 < tag_dB && tag_dB < 0.2 && tag_combRelIsoPF04dBeta < 0.15 && -0.5 < tag_dzPV && tag_dzPV < 0.5 && pair_probeMultiplicity_Pt10_M60140==1 && charge > 0) * weight '
...
eventexpMC='(tag_IsoMu27==1 && tag_pt > 29 && mass > 60 && mass < 130 && tag_charge*charge < 0 && -0.2 < tag_dB && tag_dB < 0.2 && tag_combRelIsoPF04dBeta < 0.15 && -0.5 < tag_dzPV && tag_dzPV < 0.5 && pair_probeMultiplicity_Pt10_M60140==1 && Medium > 0.5 && relTkIso < 0.10 && charge < 0) * weight'
...
### For 2016 Data & MC ###
#eventexp='tag_IsoMu24==1 && tag_pt > 27 && 60 < mass && mass < 130 && tag_charge*charge < 0 && -0.2 < tag_dB && tag_dB < 0.2 && tag_combRelIsoPF04dBeta < 0.15 && -0.5 < tag_dzPV && tag_dzPV < 0.5 && -0.5 < dzPV && dzPV < 0.5 && -0.2 < dB && dB < 0.2 && combRelIsoPF04dBeta < 0.15 && Tight2012 > 0.5 && pair_probeMultiplicity==1 && pair_deltaR > 0.4'
#eventexpMC='(tag_IsoMu24==1 && tag_pt > 27 && 60 < mass && mass < 130 && tag_charge*charge < 0 && -0.2 < tag_dB && tag_dB < 0.2 && tag_combRelIsoPF04dBeta < 0.15 && -0.5 < tag_dzPV && tag_dzPV < 0.5 && -0.5 < dzPV && dzPV < 0.5 && -0.2 < dB && dB < 0.2 && combRelIsoPF04dBeta < 0.15 && Tight2012 > 0.5 && pair_probeMultiplicity==1 && pair_deltaR > 0.4) * weight'

#wonjuntnpdir='/data1/wonjun/public/TnPTreeZ_LegacyRereco07Aug17_SingleMuon_Run2016/'
...
biningDef = [
    ...
    #{ 'var' : 'pt' , 'type': 'float', 'bins': [20, 25, 30, 35, 40, 45, 50, 60, 120] },     ### For Mu17, IDISO
    { 'var' : 'pt' , 'type': 'float', 'bins': [10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 120] },   ### For Mu8
]
