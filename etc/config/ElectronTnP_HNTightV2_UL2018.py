...
samplesDef = {
    'data'   : tnpSamples.HNtypeI['data2018'].clone(),
    'mcNom'  : tnpSamples.HNtypeI['mg2018'].clone(),
    'mcAlt'  : tnpSamples.HNtypeI['amc2018'].clone(),
    'tagSel' : tnpSamples.HNtypeI['mg2018'].clone(),
}
...
baseOutDir = 'results/HNtypeIElectronID_UL2018/'
