...
samplesDef = {
    'data'   : tnpSamples.AFB['data2018_official_L1matched'].clone(),
    'mcNom'  : tnpSamples.AFB['mg2018_official_L1matched'].clone(),
    'mcAlt'  : tnpSamples.AFB['powheg2018_official_L1matched'].clone(),
    'tagSel' : tnpSamples.AFB['mg2018_official_L1matched'].clone(),
}
samplesDef['tagSel'].rename('mcAltSel_'+samplesDef['tagSel'].name)
samplesDef['tagSel'].set_cut('tag_Ele_pt > 37')

baseOutDir = 'results/AFBElectronTrigger2018_v1_3/'
