...
samplesDef = {
    'data'   : tnpSamples.HNtypeI['data2016b'].clone(),
    'mcNom'  : tnpSamples.HNtypeI['mg2016b'].clone(),
    'mcAlt'  : tnpSamples.HNtypeI['amc2016b'].clone(),
    'tagSel' : tnpSamples.HNtypeI['mg2016b'].clone(),
}
...
baseOutDir = 'results/HNtypeIElectronID_UL2016b/'
