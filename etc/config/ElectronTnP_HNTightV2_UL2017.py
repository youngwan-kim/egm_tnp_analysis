...
samplesDef = {
    'data'   : tnpSamples.HNtypeI['data2017'].clone(),
    'mcNom'  : tnpSamples.HNtypeI['mg2017'].clone(),
    'mcAlt'  : tnpSamples.HNtypeI['amc2017'].clone(),
    'tagSel' : tnpSamples.HNtypeI['mg2017'].clone(),
}
...
baseOutDir = 'results/HNtypeIElectronID_UL2017/'
